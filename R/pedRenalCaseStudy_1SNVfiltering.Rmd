...
```{r}
renalGPV <- c('FH','TSC1', 'TSC2', 'FLCN', 'SDHA', 'SDHB', 'SDHC', 'SDHD', 'BAP1', 'PTEN')
...
Let's proceed.  With the exact binomial test, we called 5352 somatic variants and 42701 germline variants across the four tumors and two normal tissue samples.
